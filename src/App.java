    ...
    public static void main(String[] args) {
        ...
        for (Map.Entry<Integer, String> entry : entries.entrySet()) {
            if (entry.getValue() != null && entry.getValue().equals("Valor 4")) {
                ...
                celularesPersonas.put(new Persona(456789, "Lucía", "Espándola"), "+54789465");
                ...
                treeMapEntries.put(new Persona(2365, "Brenda", "Zattera"), "+54123456");
                treeMapEntries.put(new Persona(456789, "Lucía", "Espándola"), "+54789465");
